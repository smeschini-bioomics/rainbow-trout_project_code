...
# Directories
base_dir    <- "04_brms_regression/brms_best_family_final_batch_fixed_20260707_125553"
...
TISSUE <- "Liver"   # set explicitly here; use "Liver" when you run the liver hPTM version
LAYER  <- "hPTM"
