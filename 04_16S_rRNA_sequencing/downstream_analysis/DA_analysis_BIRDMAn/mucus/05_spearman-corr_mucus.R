...
infile <- "export_for_R/spearman_corr_mucus/mucus_spearman_CLR_results_LONG.tsv"
...
pdf_file <- file.path(out_dir, "mucus_spearman_CLR_heatmap.pdf")
tiff_file <- file.path(out_dir, "mucus_spearman_CLR_heatmap.tiff")
